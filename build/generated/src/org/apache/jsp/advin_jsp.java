...
public final class advin_jsp extends org.apache.jasper.runtime.HttpJspBase
        ...
        String empid=request.getParameter("empid");
         String empname=request.getParameter("empname");
          ...
          String healthadv=request.getParameter("healthadv");
           String festivadv=request.getParameter("festivadv");
       ...
       ps.setString(1,empid);
        ps.setString(2,empname);
         ps.setString(3,emailid);
          ...
          ps.setString(7,vehicleadv);
           ps.setString(8,festivadv);
           ps.setString(9,healthadv);
